...
class TestReleaseCategories(unittest.TestCase):
    ...
    def test_get_release_categories(self):
        ...
        self.assertEquals(3, len(categories["releaseCategories"]))
        self.assertEquals(self.valid_cats[0], categories["releaseCategories"][0]["id"])
        self.assertEquals("testCategory1", categories["releaseCategories"][0]["category"])
        self.assertEquals(self.valid_cats[2], categories["releaseCategories"][2]["id"])
        self.assertEquals("testCategory3", categories["releaseCategories"][2]["category"])
