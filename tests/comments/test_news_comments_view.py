...
class TestCommentsNewsView(unittest.TestCase):
    ...
    def test_getting_comments_for_one_news(self):
        ...
        self.assertEquals(self.news_ids[0], data["comments"][0]["newsID"])
        self.assertEquals("UnitTest1", data["comments"][0]["name"])
        self.assertEquals("N1C1 Comment", data["comments"][0]["comment"])
        self.assertEquals("UnitTest2", data["comments"][1]["name"])
        self.assertEquals("N1C2 Comment", data["comments"][1]["comment"])
    ...
    def test_adding_a_comment_as_registered_user(self):
        ...
        self.assertEquals("N3C1 Comment", comments[0].Comment)
        self.assertEquals("N3 UnitTest Brand New", comments[1].Comment)
    ...
    def test_adding_a_comment_as_registered_user_with_invalid_token(self):
        ...
        self.assertEquals("N2C1 Comment", comments[0].Comment)
    ...
    def test_adding_another_comment_as_registered_user_for_same_news(self):
        ...
        self.assertEquals(2, len(comments))
        self.assertEquals("N3C1 Comment", comments[0].Comment)
        self.assertEquals("N3 UnitTest Comment Same", comments[1].Comment)
    ...
    def test_editing_a_comment(self):
        ...
        self.assertEquals("N1C2 Comment", comments[1].Comment)
    ...
    def test_deleting_a_comment(self):
        ...
        self.assertEquals(1, len(comments))
        self.assertEquals("N1C2 Comment", comments[0].Comment)
